#!/bin/bash
# This file has been copied from https://github.com/docker-library/mysql/blob/master/5.7/Dockerfile
# and modified to allow specifying a .sql init script to prepopulate the database when initialized
set -e
